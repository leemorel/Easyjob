...
public class ModifyJobActivity extends AppCompatActivity {
    ...
    private void showjob(){
        et_j_address.setText(Info.jaddress);
        et_j_details.setText(Info.jdetails);
        et_j_requirement.setText(Info.jrequirement);
        et_j_salary.setText(Info.jsalayr);
        et_j_title.setText(Info.jtitle);
        et_j_time.setText(Info.jtime);
    }
