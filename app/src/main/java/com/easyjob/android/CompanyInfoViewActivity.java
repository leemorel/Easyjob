...
public class CompanyInfoViewActivity extends AppCompatActivity {
        ...
        inputDialog.setPositiveButton("确定",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                                ...
                                partimer_info.setObjectId(Info.p_id);
    ...
    private void showInfo() {
        ...
        Picasso.with(CompanyInfoViewActivity.this).load(Info.ravatar).error(R.drawable.ic_default_avator).into(im_recruiter_avator);
