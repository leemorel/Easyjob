...
public class ModifyPartimerInfoActivity extends AppCompatActivity {
    ...
    protected void onResume(){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Picasso.with(ModifyPartimerInfoActivity.this).load(Info.p_avatar).fit().into(ib_partimer_avatar);
            }
        }, 1500);
    ...
    private void initView(){
        ...
        et_partimer_phone.setText(Info.p_phone);
    ...
    private void showInfo(){
        et_partimer_name.setText(Info.p_name);
        et_partimer_age.setText(Info.p_age);
        et_partimer_education.setText(Info.p_education);
        et_partimer_height.setText(Info.p_height);
        et_partimer_phone.setText(Info.p_phone);
        et_partimer_email.setText(Info.p_email);
        et_partimer_introduciton.setText(Info.p_introduction);
        String s=Info.p_sex;
        switch (s){
            case "男":
    ...
    private void upload(final String imgpath){
        ...
        avatar.uploadblock(new UploadFileListener() {
            ...
            private void relevantPartimerInfo() {
                ...
                p1.update(Info.p_id, new UpdateListener() {
                    @Override
                    public void done(BmobException e) {
                        if (e == null) {
    ...
    private void saveLocal(){
        Info.p_sex=sex;
        Info.p_introduction=introduction;
        Info.p_height=height;
        Info.p_education=education;
        Info.p_email=email;
        Info.p_phone=phone;
        Info.p_name=name;
        Info.p_age=age;
    ...
    private void add_partimer_info() {
        ...
        p.update(Info.p_id,new UpdateListener() {
            @Override
            public void done(BmobException e) {
                if (e == null) {
