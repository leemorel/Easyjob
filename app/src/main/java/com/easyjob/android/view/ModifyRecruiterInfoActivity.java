...
public class ModifyRecruiterInfoActivity extends AppCompatActivity {
    ...
    protected void onResume(){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Picasso.with(ModifyRecruiterInfoActivity.this).load(Info.getRavatar()).fit().into(im_recruiter_avator);
            }
        }, 1500);
    ...
    private void showInfo() {
        et_recruiter_company.setText(Info.getRcompany());
        et_recruiter_address.setText(Info.getRaddress());
        et_recruiter_email.setText(Info.getRemail());
        et_recruiter_phone.setText(Info.getRphone());
        et_recruiter_introduction.setText(Info.getRprofile());


        final ImageView imageView = new ImageView(ModifyRecruiterInfoActivity.this);
        Picasso.with(ModifyRecruiterInfoActivity.this).load(Info.getRavatar()).into(imageView, new Callback() {
            @Override
    ...
    private void add_cruiter_info(){
        ...
        r.update(Info.getRecruiter_id(), new UpdateListener() {
            @Override
    ...
    private void saveLocal(){
        Info.setRaddress(et_recruiter_address.getText().toString());
        Info.setRcompany(et_recruiter_company.getText().toString());
        Info.setRemail(et_recruiter_email.getText().toString());
        Info.setRprofile(et_recruiter_introduction.getText().toString());
        Info.setRphone(et_recruiter_phone.getText().toString());
    }
        ...
        avatar.uploadblock(new UploadFileListener() {
            ...
            public void done(BmobException e) {
                if(e==null){
                    ...
                    Info.setRavatar(avatar.getFileUrl());
            ...
            private void relevantRecruiterInfo(){
                ...
                r2.update(Info.getRecruiter_id(), new UpdateListener() {
                    @Override
                    public void done(BmobException e) {
                        if(e==null){
                        }else{
