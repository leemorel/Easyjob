...
import com.easyjob.android.adapter.PartimejobViewAdapter;
                ...
                CityPicker.from(PartimerHomeFragment.this)
                        ...
                        .setOnPickListener(new OnPickListener() {
                            ...
                            public void onPick(int position, City data) {
                                Info.setCity(data.getName().replace("市",""));
                                getdata(Info.getCity());
                            ...
                            public void onLocate() {
                                ...
                                if(ContextCompat.checkSelfPermission(getContext(), Manifest.permission.ACCESS_FINE_LOCATION)
                                    ...
                                    new Handler().postDelayed(new Runnable() {
                                        ...
                                        public void run() {
                                            //定位完成之后更新数据
                                            CityPicker.from(PartimerHomeFragment.this).locateComplete(new LocatedCity(Info.getCity(),"",""),LocateState.SUCCESS);
                                        }
                                    }, 3000);
                                }
                            }
